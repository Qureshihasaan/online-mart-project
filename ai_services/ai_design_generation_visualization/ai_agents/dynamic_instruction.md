...
Prompt Engineering: Craft a detailed, technical prompt. Include Print Optimization keywords such as "Sharp edges," "Balanced negative space," and "Color-separated."
